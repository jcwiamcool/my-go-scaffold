...
# COPY 源路径 目标路径
COPY . $GOPATH/src/github.com/jcwiamcool/my-go-scaffold

# RUN 执行 go build .
RUN cd $GOPATH/src/github.com/jcwiamcool/my-go-scaffold && go build .
...
COPY --from=builder /opt/repo/src/github.com/jcwiamcool/my-go-scaffold /opt
